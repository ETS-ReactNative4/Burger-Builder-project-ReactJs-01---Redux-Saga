...
const BuildControls=(props)=>{
    return(
        <div className={CssBuildControls.BuildControls}>
            ...
            <button className={CssBuildControls.OrderButton} disabled={!props.purchasable} onClick={props.purchasing}>{props.isAuthenticated ? 'Order Now':'Sign-up to Order'}</button>
        </div>
    )
};
